              ...
              ?>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="No_urut">
                    <?php
                    $sql = mysqli_query($conn, "SELECT No_urut, Nama FROM pelanggan ORDER BY Nama");
                    while ($hasil = mysqli_fetch_array($sql)){
                      ?>
                    <option value="<?php echo $hasil['No_urut']; ?>"><?php echo $hasil['Nama']; ?></option>
                    <?php
                        }
                    ?>
                  </select>
                ...
                <div class="form-group">
                  ...
                  <input type="number" id="total_berat" class="form-control" name="total_berat" placeholder="Total Berat" value="0">
                </div>
                <div class="form-group">
                  <label>Diskon</label>
                ...
                <a href="tambahdatatransaksi.php"><input type="button" class="btn btn-default" value="Batal" ></a>
                </form>
          </div>
